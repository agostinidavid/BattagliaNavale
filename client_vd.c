...
int video()
{
    while(1+1==2)
    {
        ...
        while (recv(sock, buffer, 255, 0) > 0 && flag == 0) 
        {
            ...
            mark(buffer[1],buffer[2],buffer[3]);
            system("cls");
            print();
        }
    }
...
int place()
{
    ...
    if(rotation==1)
    {
        if(B4>0)
        {
            if(controlboat(B4,number,letter,4)==1)
            {
                for(c=0;c!=4;c++)
                {
                    t[number][letter]=1;
    ...
    else if (rotation=2)
    {
        ...
        else if(B3>0)
        {
            ...
            if(controlboat(B3,number,letter,3)==1)
            {
                for(c=0;c!=3;c++)
                {
                    t[number][letter]=1;
        ...
        else if(B2>0)
        {
            ...
            if(controlboat(B2,number,letter,2)==1)
            {
                for(c=0;c!=2;c++)
                {
                    t[number][letter]=1;
        ...
        else
        {
            ...
            if(controlboat(B1,number,letter,1)==1)
            {
                for(c=0;c!=1;c++)
                {
                    t[number][letter]=1;
...
int controlboat(int boat,int num,int let,int n)
{
    int c;
    if(boat>0)
    {
...
int main()
{
    system("title BATTAGLIA NAVALE - Avversario ");
    vdconnect();
    svconnect();
    video();
}